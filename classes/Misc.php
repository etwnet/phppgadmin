...
EOT;
	 ...
	 * @param $page int - the page currently viewed
	 ...
	 * @param $tabledata  ADORecordSet A set of data to be formatted, as returned by $data->getDatabases() etc.
	 * @param $columns   array An associative array of columns to be displayed:
	 *         $columns = array(
	 *            column_id => array(
	 ...
	 *            ), ...
	 *         );
	 * @param $actions   array Actions that can be performed on each object:
	 *         $actions = array(
	 ...
	 *            ), ...
	 *         );
	 * @param $place     string Place where the $actions are displayed. Like 'display-browse', where 'display' is the file (display.php)
	 *                   and 'browse' is the place inside that code (doBrowse).
	 * @param $nodata    string (optional) Message to display if data set is empty.
	 * @param $pre_fn    callable (optional) Name of a function to call for each row,
